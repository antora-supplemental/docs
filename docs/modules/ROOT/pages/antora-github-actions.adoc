...
** Private repos use the sibling link:https://github.com/antora-supplemental/.github-private[`.github-private`^] repository for the same role.
...
Org-wide profile README, brand assets, and the public/private split are documented in xref:org-github-config.adoc[Org GitHub config].
